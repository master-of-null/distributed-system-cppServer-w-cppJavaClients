...
public:
   ...
   virtual double distanceEarth(int fromLatDeg, int fromLonDeg, int toLatDeg, int toLonDeg);
   virtual double bearing(int fromLatDeg, int fromLonDeg, int toLatDeg, int toLonDeg);
